  ...
  return (
    <ErrorBoundary>
      <div className={isCssFullScreen ? 'fixed inset-0 z-50 bg-slate-950' : 'bg-slate-900 min-h-screen text-white'}>
        ...
        {/* ... (deckImportModalOpen, skipModalOpen, importModalOpen 렌더링 유지) */}
        ...
        {/* 🌟 [수정] 자식 컴포넌트들에 getCardDef 대신 enhancedGetCardDef 주입 */}
