...
export const CARD_LIBRARY = [
  ...
  { id: 'emergency_kit', name: '긴급 구호', type: 'special', cost: 0, rarity: 'uncommon', cleanse: true, heal: 6, desc: '비상 상황에서 즉각 치료를 개시합니다. 상태이상 1개를 해제하고 체력 6을 회복합니다. 침묵·속박 상태에서도 사용 가능.' },
  ...
  { id: 'molotov', name: '화염병', type: 'skill', cost: 1, rarity: 'uncommon', enemyBurn: 5, exhaust: true, desc: '기름이 가득 든 화염병을 투척해 적에게 화상 5를 부여합니다. (사용 후 소멸)' },
