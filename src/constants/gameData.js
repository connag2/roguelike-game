...
export const CARD_LIBRARY = [
  ...
  // 일반 (Common)
  { id: 'flame_slash', name: '화염 베기', type: 'attack', cost: 1, rarity: 'common', damage: 8, enemyBurn: 5, desc: '검에 불꽃을 머금고 베어 8의 피해를 주고 화상 5를 부여합니다.' },
  { id: 'frost_arrow', name: '빙결 화살', type: 'attack', cost: 1, rarity: 'common', damage: 8, enemyFrost: 3, desc: '얼어붙은 화살을 쏘아 8의 피해를 주고 동상 3을 부여합니다.' },
  { id: 'frozen_shield', name: '얼어붙은 방패', type: 'skill', cost: 1, rarity: 'common', block: 10, enemyFrost: 2, desc: '냉기를 뿜는 방패를 들어 10의 방어도를 얻고 적에게 동상 2를 부여합니다.' },
  ...
  { id: 'absolute_purify', name: '완전 정화', type: 'special', cost: 3, rarity: 'rare', cleanseAll: true, desc: '눈부신 성광이 몸을 감싸며 모든 상태 이상을 한 번에 씻어냅니다. 침묵·속박 상태에서도 사용 가능.' },
  { id: 'pain_conversion', name: '고통 전환', type: 'special', cost: 1, rarity: 'uncommon', debuffToBlock: 6, desc: '고통을 의지로 방어막으로 바꿉니다. 활성 상태이상 1개당 방어도 6을 획득합니다. 침묵·속박 상태에서도 사용 가능.' },
  { id: 'vital_absorption', name: '활력 흡수', type: 'special', cost: 2, rarity: 'uncommon', debuffToHeal: 8, desc: '상태이상의 에너지를 역이용해 체력을 끌어올립니다. 활성 상태이상 1개당 체력 8을 회복합니다. 침묵·속박 상태에서도 사용 가능.' },
  { id: 'adversity_power', name: '역경의 힘', type: 'special', cost: 2, rarity: 'rare', debuffToStrength: 2, desc: '고난을 딛고 더욱 강해집니다. 활성 상태이상 1개당 근력 2를 획득하고 모든 상태이상을 해제합니다. 침묵·속박 상태에서도 사용 가능.' },
  { id: 'pain_lash', name: '고통의 반격', type: 'special', cost: 1, rarity: 'uncommon', debuffToDamage: 10, desc: '내 고통을 적에게 되돌려 줍니다. 활성 상태이상 1개당 10의 피해를 줍니다. 침묵·속박 상태에서도 사용 가능.' },
  { id: 'iron_will', name: '강철 의지', type: 'special', cost: 0, rarity: 'common', cleanse: true, block: 4, desc: '굳센 의지로 상태이상 1개를 떨쳐내고 4의 방어도를 얻습니다. 침묵·속박 상태에서도 사용 가능.' },
  { id: 'second_wind', name: '두 번째 바람', type: 'special', cost: 2, rarity: 'uncommon', cleanseAll: true, heal: 12, desc: '숨을 고르고 전열을 재정비합니다. 모든 상태이상을 해제하고 체력 12를 회복합니다. 침묵·속박 상태에서도 사용 가능.' },
  { id: 'battle_meditation', name: '전투 명상', type: 'special', cost: 1, rarity: 'common', debuffToBlock: 4, manaGain: 1, desc: '전투 중 짧은 명상으로 상태이상을 방어막으로 전환하고 마나 1을 회복합니다. 침묵·속박 상태에서도 사용 가능.' },
  { id: 'quick_strike', name: '신속한 타격', type: 'attack', cost: 0, rarity: 'common', damage: 6, draw: 1, desc: '눈에 보이지 않을 만큼 빠른 잽으로 6의 피해를 주고 다음 행동을 위해 카드 1장을 뽑습니다.' },
  { id: 'angry_strike', name: '분노의 일격', type: 'attack', cost: 1, rarity: 'common', damage: 14, selfDamage: 2, selfRage: 2, desc: '근육이 찢어지는 것을 감수하며 무기를 휘두릅니다. 14의 피해를 주지만 체력을 2 잃고 격노 2를 얻습니다.' },
  ...
  { id: 'crouch', name: '웅크리기', type: 'skill', cost: 1, rarity: 'common', block: 8, selfThorns: 2, desc: '몸을 둥글게 웅크려 8의 방어도를 얻고 가시 2를 얻습니다.' },
  { id: 'primal_roar', name: '원초의 포효', type: 'special', cost: 2, rarity: 'rare', debuffToStrength: 1, debuffToDamage: 8, desc: '모든 고통을 힘으로 전환해 포효합니다. 상태이상 1개당 근력 1과 피해 8을 동시에 얻고 해제합니다. 침묵·속박 상태에서도 사용 가능.' },
  ...
  { id: 'spiked_shield', name: '가시 방패', type: 'skill', cost: 1, rarity: 'common', block: 6, selfThorns: 4, desc: '가시 돋친 방패를 앞세웁니다. 6의 방어도를 얻고 가시 4를 얻습니다.' },
  { id: 'twin_strike', name: '쌍발 타격', type: 'attack', cost: 1, rarity: 'common', damage: 4, multiHit: 2, desc: '양손의 무기를 번갈아 휘둘러 4의 피해를 2번 연속 줍니다.' },

    { id: 'gamblers_strike', name: '도박사의 일격', type: 'attack', cost: 1, rarity: 'common', gamble: true, gambleWinChance: 0.5, winDamage: 14, winEnemyVuln: 1, loseDamage: 6, desc: '감각에 의존해 운명의 타격을 날립니다. 50% 확률로 14의 피해와 취약 1을 주며, 실패해도 6의 피해를 줍니다.' },
  ...
  { id: 'dash', name: '돌진', type: 'attack', cost: 1, rarity: 'uncommon', damage: 10, block: 10, desc: '방패를 앞세워 맹렬히 돌격합니다. 10의 피해를 주고 10의 방어도를 얻습니다.' },
  ...
  { id: 'bleed_cut', name: '출혈 베기', type: 'attack', cost: 1, rarity: 'uncommon', damage: 8, enemyBleed: 2, desc: '날카로운 칼날로 깊은 상처를 내어 8의 피해를 주고 출혈 2를 부여합니다.' },
  { id: 'molotov', name: '화염병', type: 'skill', cost: 1, rarity: 'uncommon', enemyBurn: 8, exhaust: true, desc: '기름이 가득 든 화염병을 투척해 적에게 화상 8을 부여합니다. (사용 후 소멸)' },
  { id: 'weakness_exploit', name: '약점 포착', type: 'attack', cost: 1, rarity: 'uncommon', damage: 10, doubleDamageIfVuln: true, desc: '적의 틈을 노립니다. 10의 피해를 주며, 대상이 취약 상태라면 2배의 피해를 줍니다.' },
  ...
  { id: 'mana_infusion', name: '마나 주입', type: 'skill', cost: 0, rarity: 'uncommon', manaGain: 2, enemyFrail: 1, desc: '불안정한 마력을 적의 체내에 주입시켜 마나를 2 얻고 허약 1을 부여합니다.' },
    ...
    { id: 'unstable_bomb', name: '불안정한 폭약', type: 'attack', cost: 1, rarity: 'uncommon', gamble: true, gambleWinChance: 0.65, winDamage: 16, winEnemyBurn: 4, loseDamage: 8, loseSelfBurn: 1, desc: '심지가 불량한 폭탄을 던집니다. 65% 확률로 16의 피해와 화상 4를 줍니다. 실패 시 8의 피해를 주고 자신에게 화상 1을 입습니다.' },
  { id: 'lucky_coin', name: '행운의 동전', type: 'skill', cost: 1, rarity: 'uncommon', gamble: true, gambleWinChance: 0.6, winManaGain: 2, winDraw: 1, loseBlock: 5, desc: '동전을 높이 튕깁니다. 60% 확률로 마나 2를 얻고 카드를 1장 뽑습니다. 실패 시 방어도 5를 얻습니다.' },
  // 전설 (Rare)
  { id: 'vampire_sword', name: '뱀파이어의 검', type: 'attack', cost: 2, rarity: 'rare', damage: 16, heal: 7, enemyWeak: 1, desc: '피를 갈구하는 마검을 휘둘러 16의 피해를 주고 체력을 7 회복하며 약화 1을 부여합니다.' },
  ...
  { id: 'execute', name: '처형', type: 'attack', cost: 2, rarity: 'rare', damage: 18, doubleDamageIfVuln: true, desc: '자비 없이 적의 숨통을 끊어버릴 기세로 참수합니다. 18의 피해를 주며 대상이 취약 상태라면 2배(36)의 피해를 줍니다.' },
  ...
  { id: 'bramble_armor', name: '덩굴 갑옷', type: 'skill', cost: 2, rarity: 'rare', block: 20, selfThorns: 8, desc: '가시 돋친 마계 덩굴로 온몸을 감싸 20의 방어도를 얻고 가시 8을 얻습니다.' },
  ...
  // 신화 (Mythic)
  { id: 'omniscience', name: '전지전능', type: 'skill', cost: 3, rarity: 'mythic', draw: 4, percentManaRefund: 0.5, percentEnemyCurrentHp: 0.15, enemyWeak: 2, enemyVuln: 2, desc: '우주의 이치를 깨닫습니다. 카드를 4장 뽑고 이번 턴 소모한 마나의 50%를 회복하며, 모든 적에게 현재 체력 15% 피해와 약화 2, 취약 2를 부여합니다.' },
  { id: 'phantom_walk', name: '환영 보법', type: 'skill', cost: 2, rarity: 'mythic', selfPhantomWalk: true, exhaust: true, desc: '몸을 잔상으로 분리합니다. 1턴 동안 받는 피해가 75% 감소하고, 감소한 피해의 50%를 공격자에게 반사합니다. (소멸)' },
  { id: 'furioso', name: 'Furioso (퓨리오소)', type: 'attack', cost: 3, rarity: 'mythic', damage: 7, multiHit: 6, percentMissingHpFinisher: 0.25, desc: '미친듯한 템포로 적을 난도질합니다. 7의 피해를 6번 연속 주며, 마지막 일격에 적 잃은 체력의 25%만큼의 추가 처형 피해를 입힙니다.' },
  { id: 'genesis', name: '창세기', type: 'skill', cost: 3, rarity: 'mythic', percentMaxHpHeal: 0.3, selfGenesis: true, exhaust: true, desc: '태초의 생명력을 일깨웁니다. 최대 체력의 30%를 즉시 회복하고, 이번 전투 동안 모든 피해량과 방어도가 25% 증가합니다. (소멸)' },
];
// ==========================================
...
export const ENEMIES = [
  ...
  { name: '고블린', baseHp: 43, deck: [
    { name: '단검 찌르기', type: 'attack', value: 9, desc: '품속에서 녹슨 단검을 꺼내 비열하고 교묘하게 찔러넣어 10의 피해를 줍니다.' }, 
    { name: '방어 태세', type: 'defend', value: 9, desc: '나무 방패 뒤로 몸을 잔뜩 웅크리며 10의 방어도를 얻습니다.' }, 
    { name: '모래 뿌리기', type: 'debuff', debuff: 'weak', turns: 2, desc: '발밑의 흙먼지를 걷어차 시야를 가립니다. 약화 2를 부여합니다.' }
  ]},
  { name: '늑대', baseHp: 50, deck: [
    { name: '물어뜯기', type: 'attack', value: 11, desc: '굶주린 턱을 크게 벌려 팔다리를 으스러지게 물어뜯어 12의 피해를 줍니다.' }, 
    { name: '울부짖기', type: 'debuff', debuff: 'vulnerable', turns: 2, desc: '소름 끼치는 하울링으로 뼈를 스미는 공포를 줍니다. 취약 2를 부여합니다.' }
  ]},
  { name: '스켈레톤', baseHp: 56, deck: [
    { name: '뼈 던지기', type: 'attack', value: 13, desc: '자신의 갈비뼈를 하나 뽑아 날카로운 투창처럼 던져 14의 피해를 줍니다.' }, 
    { name: '방패 올리기', type: 'defend', value: 11, desc: '낡은 철제 방패를 굳건히 들어 올려 12의 방어도를 얻습니다.' }, 
    { name: '2연참', type: 'attack', value: 7, multi: 2, desc: '녹슨 검을 X자로 빠르게 두 번 휘둘러 7의 피해를 2번 줍니다.' }
  ]},
  { name: '유령', baseHp: 47, deck: [
    { name: '원혼의 손길', type: 'attack_debuff', value: 8, debuff: 'weak', turns: 1, desc: '얼어붙은 손아귀로 영혼을 쓰다듬어 8의 피해를 주고 약화 1을 부여합니다.' }, 
    { name: '꿰뚫기', type: 'attack', value: 15, desc: '반투명한 몸으로 쏜살같이 날아와 가슴을 관통하며 16의 피해를 줍니다.' }
  ]},
  { name: '오크', baseHp: 75, deck: [
    { name: '도끼 강타', type: 'attack', value: 18, desc: '거대한 피 묻은 도끼를 머리 위에서부터 무자비하게 내리찍어 20의 피해를 줍니다.' }, 
    { name: '전투의 함성', type: 'defend_debuff', value: 9, debuff: 'vulnerable', turns: 1, desc: '피의 갈증을 담아 포효하며 10의 방어도를 얻고 압도적인 기백으로 취약 1을 부여합니다.' }
  ]},
  { name: '거미', baseHp: 52, deck: [
    { name: '맹독 이빨', type: 'attack', value: 13, desc: '독액이 뚝뚝 떨어지는 거대한 턱으로 살점을 뜯어내 14의 피해를 줍니다.' }, 
    { name: '날카로운 다리', type: 'attack_debuff', value: 7, debuff: 'bleed', turns: 3, desc: '가시 돋친 다리로 긁어 7의 피해를 주고 출혈 3을 부여합니다.' },
    { name: '거미줄 치기', type: 'debuff', debuff: 'weak', turns: 3, desc: '끈끈하고 질긴 거미줄을 뿜어내어 전신을 포박합니다. 약화 3을 부여합니다.' }
  ]},
  { name: '광신도', baseHp: 68, deck: [
    { name: '어둠의 의식', type: 'attack', value: 20, desc: '사악한 주문을 외우며 검은 구체를 만들어 쏘아내 22의 피해를 줍니다.' }, 
  ...
  { name: '가고일', baseHp: 87, deck: [
    { name: '석화', type: 'defend', value: 23, desc: '날개를 접고 몸을 돌덩이처럼 단단하게 굳혀 25의 방어도를 얻습니다.' }, 
    { name: '강하', type: 'attack', value: 17, desc: '공중으로 치솟았다가 운석처럼 떨어지며 덮쳐 18의 피해를 줍니다.' }
  ]},
  { name: '머드맨', baseHp: 62, deck: [
    { name: '진흙 던지기', type: 'attack_debuff', value: 9, debuff: 'weak', turns: 1, desc: '자신의 몸에서 악취 나는 진흙을 뭉쳐 던져 10의 피해를 주고 약화 1을 부여합니다.' }, 
    { name: '재생', type: 'heal', heal: 10, desc: '주변의 흙을 끌어모아 몸의 형태를 복구해 체력을 10 회복합니다.' }
  ]},
  { name: '미믹', baseHp: 81, deck: [
    { name: '깜짝 물기', type: 'attack', value: 17, desc: '순식간에 보물상자 뚜껑을 열고 날카로운 이빨로 물어뜯어 18의 피해를 줍니다.' }, 
    { name: '굳게 닫기', type: 'defend', value: 18, desc: '상자를 쾅 하고 닫아버려 어떠한 공격도 튕겨내는 20의 방어도를 얻습니다.' }
  ]},
  { name: '밴시', baseHp: 56, deck: [
    { name: '침묵의 비명', type: 'debuff', debuff: 'silence', turns: 1, desc: '입을 찢어지게 벌려 유령의 비명을 질러 영혼을 마비시킵니다. 침묵 1을 부여합니다.' }, 
    { name: '영혼 흡수', type: 'attack_heal', value: 11, heal: 10, desc: '생명력을 유령의 형태로 빨아들여 12의 피해를 주고 체력을 10 회복합니다.' }
  ]},
  { name: '골렘', baseHp: 100, deck: [
    { name: '바위 주먹', type: 'attack', value: 23, desc: '거대한 바위 덩어리 같은 주먹을 휘둘러 25의 피해를 줍니다.' }, 
    { name: '묵직한 가드', type: 'defend_debuff', value: 27, debuff: 'weak', turns: 1, desc: '두 팔을 교차해 30의 방어도를 얻고 압도적인 무게감으로 약화 1을 부여합니다.' }
  ]},
  { name: '켄타우로스', baseHp: 75, deck: [
    { name: '돌격', type: 'attack', value: 18, desc: '말의 하반신을 이용해 엄청난 속도로 돌진하여 창으로 찔러 20의 피해를 줍니다.' }, 
    { name: '연속 화살', type: 'attack', value: 8, multi: 3, desc: '활시위를 눈에 보이지 않게 당겨 화살 3발을 꽂아 8의 피해를 3번 줍니다.' }
  ]},
  { name: '불의 정령', baseHp: 56, deck: [
    { name: '화염구', type: 'attack', value: 11, desc: '이글거리는 불덩이를 모아 집어던져 12의 피해를 줍니다.' }, 
    { name: '화상', type: 'debuff', debuff: 'burn', turns: 5, desc: '주변 온도를 높여 살갗을 데이게 만듭니다. 화상 5를 부여합니다.' }, 
    { name: '불꽃 장벽', type: 'defend', value: 14, desc: '자신의 주위에 화염의 장막을 두루며 15의 방어도를 얻습니다.' }
  ]},
  { name: '물의 정령', baseHp: 68, deck: [
    { name: '물대포', type: 'attack', value: 9, desc: '고압의 물줄기를 쏘아내어 10의 피해를 줍니다.' }, 
  ...
  { name: '서큐버스', baseHp: 81, deck: [
    { name: '생기 흡수', type: 'attack_heal', value: 14, heal: 15, desc: '매혹적인 키스로 정기를 빨아들여 15의 피해를 주고 체력을 15 회복합니다.' }, 
    { name: '매혹', type: 'debuff', debuff: 'weak', turns: 3, desc: '관능적인 몸짓으로 시선을 빼앗아 전의를 상실하게 만들어 약화 3을 부여합니다.' }
  ]},
  { name: '듀라한', baseHp: 106, deck: [
    { name: '참수', type: 'attack', value: 23, desc: '머리 없는 기사가 대검을 섬뜩하게 휘둘러 목을 노리며 25의 피해를 줍니다.' }, 
    { name: '공포', type: 'debuff', debuff: 'vulnerable', turns: 3, desc: '들고 있는 머리가 소름 끼치게 웃어재낍니다. 취약 3을 부여합니다.' }, 
    { name: '강철 갑옷', type: 'defend', value: 18, desc: '입고 있는 검은 철갑옷의 틈새를 닫아 20의 방어도를 얻습니다.' }
  ]},
  { name: '뱀파이어 헌터', baseHp: 93, deck: [
    { name: '은탄환', type: 'attack', value: 17, desc: '장총을 정조준하고 축복받은 은탄환을 쏴 18의 피해를 줍니다.' }, 
  ...
  { name: '리자드맨', baseHp: 75, deck: [
    { name: '꼬리치기', type: 'attack', value: 13, desc: '가시 돋친 굵고 강력한 꼬리로 다리를 후려쳐 14의 피해를 줍니다.' }, 
    { name: '비늘 강화', type: 'defend', value: 14, desc: '몸의 비늘을 곤두세워 방어력을 높여 15의 방어도를 얻습니다.' }, 
    { name: '재생력', type: 'heal', heal: 12, desc: '도마뱀의 뛰어난 회복력으로 상처 부위의 살을 돋아내게 해 체력을 12 회복합니다.' }
  ]},
  { name: '하피', baseHp: 50, deck: [
  ...
  { name: '트롤', baseHp: 112, deck: [
    { name: '몽둥이 찜질', type: 'attack', value: 20, desc: '사람만한 통나무를 집어들고 사정없이 후려갈겨 22의 피해를 줍니다.' }, 
    { name: '트롤의 피', type: 'heal', heal: 25, desc: '잘려나간 살덩이가 눈에 보일 속도로 빠르게 엉겨붙어 체력을 25 회복합니다.' }
  ]},
  { name: '그림 리퍼', baseHp: 87, deck: [
    { name: '영혼 수확', type: 'attack_heal', value: 18, heal: 10, desc: '거대한 낫으로 영혼의 일부를 베어내 20의 피해를 주고 자신의 체력을 10 회복합니다.' }, 
    { name: '죽음의 선고', type: 'debuff', debuff: 'vulnerable', turns: 3, desc: '뼈만 남은 손가락으로 가리키며 죽음을 예언해 취약 3을 부여합니다.' }, 
    { name: '망령화', type: 'defend', value: 27, desc: '물리적인 형태를 버리고 검은 안개로 흩어져 30의 방어도를 얻습니다.' }
  ]},
  { name: '코카트리스', baseHp: 68, deck: [
    { name: '부리 쪼기', type: 'attack', value: 11, desc: '단단하고 뾰족한 부리로 신경질적으로 쪼아대어 12의 피해를 줍니다.' }, 
    { name: '석화의 눈', type: 'debuff', debuff: 'bind', turns: 1, desc: '기분 나쁜 붉은 눈으로 노려보아 관절을 돌로 굳게 만듭니다. 속박 1을 부여합니다.' }, 
    { name: '날개 치기', type: 'attack', value: 14, desc: '퍼덕거리는 날개로 거센 바람과 함께 타격을 가해 15의 피해를 줍니다.' }
  ]},
  { name: '다크 나이트', baseHp: 106, deck: [
    { name: '암흑 검격', type: 'attack', value: 17, desc: '검은 오오라를 두른 대검을 수직으로 내려찍어 18의 피해를 줍니다.' }, 
    { name: '어둠의 방패', type: 'defend', value: 23, desc: '빛을 굴절시키는 어두운 방패를 세워 25의 방어도를 얻습니다.' }, 
    { name: '칠흑의 기운', type: 'buff', buff: 'strength', buffValue: 2, turns: 1, desc: '갑옷 사이로 칠흑의 연기가 새어나오며 근력을 2 얻습니다.' }
  ]},
  { name: '환영술사', baseHp: 56, deck: [
    { name: '정신 파괴', type: 'attack_debuff', value: 9, debuff: 'weak', turns: 3, desc: '수많은 환영들이 속삭이며 두통을 유발해 10의 피해를 주고 약화 3을 부여합니다.' }, 
    { name: '환영 분신', type: 'defend', value: 36, desc: '주변에 똑같이 생긴 환영 분신을 다수 소환해 공격을 교란하며 40의 방어도를 얻습니다.' }
  ]},
  { name: '데몬 쥐', baseHp: 43, deck: [
  ...
  { name: '폭탄 고블린', baseHp: 50, deck: [
    { name: '자폭 투척', type: 'attack', value: 23, desc: '도화선에 불이 붙은 화약통을 낄낄대며 굴려 던져 25의 피해를 줍니다.' }, 
...
export const NORMAL_BOSSES = [
  ...
  { name: '고블린 족장', baseHp: 312, deck: [
    { name: '연속 찌르기', type: 'attack', value: 9, multi: 3, desc: '크고 화려한 창을 보이지 않는 속도로 세 번 연속 찔러 10의 피해를 3번 줍니다.' }, 
    { name: '총공격 지시', type: 'debuff', debuff: 'vulnerable', turns: 3, desc: '나팔을 불어 부하들에게 공격을 지시하며 위협을 가해 취약 3을 부여합니다.' }, 
    { name: '철벽 방어', type: 'defend', value: 36, desc: '족장의 거대한 황금 방패 뒤에 숨어 40의 방어도를 얻습니다.' }
  ]}, 
  { name: '오크 대장군', baseHp: 500, deck: [
    { name: '참수', type: 'attack', value: 36, desc: '숨통을 끊어버릴 듯한 기세로 대검을 수평으로 크게 휘둘러 40의 피해를 줍니다.' }, 
    { name: '피의 굶주림', type: 'attack_debuff', value: 23, debuff: 'vulnerable', turns: 2, desc: '피 냄새를 맡고 광기에 사로잡혀 무자비하게 후려칩니다. 25의 피해를 주고 취약 2를 부여합니다.' }, 
    { name: '대장군의 기백', type: 'defend', value: 45, desc: '전장의 공기를 짓누르는 압도적인 위압감을 뿜어내며 50의 방어도를 얻습니다.' }
  ]}, 
  { name: '뱀파이어 로드', baseHp: 812, deck: [
    { name: '생명 흡수', type: 'attack_heal', value: 32, heal: 20, desc: '붉은 기운의 촉수로 생명력을 강제로 빨아들여 35의 피해를 주고 체력을 20 회복합니다.' }, 
    { name: '혈액 부패', type: 'debuff', debuff: 'bleed', turns: 5, desc: '체내의 피를 부패시켜 출혈 5를 부여합니다.' }, 
  ...
  { name: '돌연변이 키메라', baseHp: 1000, deck: [
    { name: '독사 꼬리', type: 'attack_debuff', value: 18, debuff: 'weak', turns: 3, desc: '꼬리의 독사가 번개처럼 머리를 내밀어 물고 독을 퍼뜨려 20의 피해와 약화 3을 부여합니다.' }, 
  ...
  { name: '지옥의 파수견', baseHp: 687, deck: [
    { name: '물어뜯기', type: 'attack', value: 18, multi: 2, desc: '세 개의 머리 중 두 개가 동시에 달려들어 사지를 으스러뜨리며 20의 피해를 2번 줍니다.' }, 
    { name: '지옥의 불꽃', type: 'attack_debuff', value: 27, debuff: 'vulnerable', turns: 3, desc: '유황 냄새가 나는 지옥불을 입에서 토해내어 30의 피해를 주고 갑옷을 녹여 취약 3을 부여합니다.' }, 
  ...
  { name: '맹독의 여왕', baseHp: 750, deck: [
    { name: '맹독 가시', type: 'attack', value: 14, multi: 3, desc: '등에 돋친 독가시를 기관총처럼 쏘아내어 15의 피해를 3번 연속 줍니다.' }, 
...
export const HARD_MODE_BOSSES = [
  { name: '솜뭉치 유령', baseHp: 250, deck: [
    { name: '솜뭉치 펀치', type: 'attack', value: 14, desc: '가벼워 보이지만 은근히 묵직한 솜주먹을 뻗어 얼굴을 강타해 15의 피해를 줍니다.' }, 
    { name: '폭신폭신', type: 'defend', value: 27, desc: '몸을 더욱 거대하고 푹신하게 부풀려 모든 충격을 흡수할 30의 방어도를 얻습니다.' }, 
    { name: '재채기 가루', type: 'debuff', debuff: 'weak', turns: 2, desc: '콧구멍을 간지럽히는 저주받은 솜털을 훅 불어넣어 약화 2를 부여합니다.' }
  ]},
  { name: '심술쟁이 요정', baseHp: 312, deck: [
  ...
  { name: '서큐버스 동생 리리', baseHp: 375, deck: [
    { name: '하트 브레이커', type: 'attack_debuff', value: 18, debuff: 'vulnerable', turns: 2, desc: '손키스를 날려 파괴적인 핑크빛 하트를 터뜨려 20의 피해를 주고 취약 2를 부여합니다.' }, 
    { name: '달콤한 속삭임', type: 'debuff', debuff: 'silence', turns: 1, desc: '귓가에 달콤하고 음탕한 말을 속삭여 정신을 잃게 만들어 침묵 1을 부여합니다.' }, 
    { name: '언니 도와줘!', type: 'defend_buff', value: 36, buff: 'strength', buffValue: 2, desc: '애처로운 목소리로 울먹이며 방어 자세를 취해 40의 방어도를 얻고 분노하여 근력을 2 얻습니다.' }
  ]},
  { name: '서큐버스 언니 롤라', baseHp: 437, deck: [
    { name: '사랑의 채찍', type: 'attack', value: 11, multi: 3, desc: '가죽 채찍을 사디스틱하게 휘둘러 찰진 소리와 함께 12의 피해를 3번 줍니다.' }, 
    { name: '정기 흡수', type: 'attack_heal', value: 23, heal: 25, desc: '강제로 입을 맞춰 생명 에너지를 진득하게 빨아들여 25의 피해를 주고 체력을 25 회복합니다.' }, 
    { name: '위험한 매력', type: 'debuff', debuff: 'bind', turns: 1, desc: '도발적인 포즈와 눈웃음으로 발을 얼어붙게 만들어 속박 1을 부여합니다.' }
  ]},
  { name: '화가 난 호박 기사', baseHp: 500, deck: [
    { name: '호박 머리 박치기', type: 'attack', value: 32, desc: '불타는 호박 머리를 들이밀며 무식하게 박치기를 해 35의 피해를 줍니다.' }, 
    { name: '넝쿨 묶기', type: 'attack_debuff', value: 14, debuff: 'frail', turns: 3, desc: '바닥에서 가시 넝쿨을 피워내 사지를 묶어 15의 피해를 주고 허약 3을 부여합니다.' }, 
    { name: '단단한 껍질', type: 'defend', value: 45, desc: '호박 껍질을 더욱 두껍고 단단하게 경화시켜 50의 방어도를 얻습니다.' }
  ]},
  { name: '거대 꿀벌 여왕', baseHp: 562, deck: [
    { name: '독침 찌르기', type: 'attack_debuff', value: 23, debuff: 'poison', turns: 4, desc: '창만큼 거대한 독침을 몸에 푹 박아넣어 25의 피해를 주고 중독 4를 부여합니다.' }, 
    { name: '페로몬 살포', type: 'debuff', debuff: 'mark', turns: 3, desc: '타겟을 지정하는 특수 페로몬 가루를 흩날려 표식 3을 부여합니다.' }, 
    { name: '일벌 소환', type: 'defend', value: 54, desc: '수백 마리의 일벌 떼를 몸 주위에 뭉치게 해 60의 방어도를 얻습니다.' }
  ]},
  { name: '달빛 늑대인간', baseHp: 625, deck: [
    { name: '광란의 발톱', type: 'attack', value: 18, multi: 2, desc: '이성을 잃고 짐승처럼 울부짖으며 앞발을 마구 휘둘러 20의 피해를 2번 줍니다.' }, 
    { name: '피의 갈증', type: 'buff', buff: 'strength', buffValue: 3, desc: '피 냄새에 취해 근육이 비정상적으로 부풀어 오르며 근력을 3 얻습니다.' }, 
    { name: '물어뜯기', type: 'attack_heal', value: 27, heal: 20, desc: '목덜미를 짐승의 턱으로 잔인하게 물어뜯어 30의 피해를 주고 체력을 20 회복합니다.' }
  ]},
  { name: '광기의 연금술사', baseHp: 687, deck: [
    { name: '화학 물질 투척', type: 'attack', value: 41, desc: '정체불명의 폭발성 플라스크를 마구 집어던져 45의 피해를 줍니다.' }, 
    { name: '유독 가스', type: 'debuff', debuff: 'poison', turns: 5, desc: '녹색의 숨막히는 유독 가스 밸브를 열어 중독 5를 부여합니다.' }, 
    { name: '돌연변이 물약', type: 'defend_buff', value: 36, buff: 'strength', buffValue: 4, desc: '기괴한 약물을 들이켜 40의 방어도를 얻고 몸집이 비대해지며 근력을 4 얻습니다.' }
  ]},
  { name: '고대 유적의 파수꾼', baseHp: 750, deck: [
    { name: '레이저 빔', type: 'attack', value: 45, desc: '외눈에서 모든 것을 태우는 고열의 붉은 레이저를 발사해 50의 피해를 줍니다.' }, 
    { name: '강제 제압', type: 'attack_debuff', value: 18, debuff: 'bind', turns: 1, desc: '기계 팔로 강하게 짓눌러 20의 피해를 주고 움직임을 봉쇄해 속박 1을 부여합니다.' }, 
    { name: '방어막 전개', type: 'defend', value: 72, desc: '푸른 육각형의 에너지 쉴드를 전면에 전개하여 80의 방어도를 얻습니다.' }
  ]},
  { name: '빙결의 마녀', baseHp: 812, deck: [
    { name: '얼음 송곳', type: 'attack', value: 14, multi: 3, desc: '공기 중의 수분을 얼려 날카로운 얼음창을 세 발 연속 발사해 15의 피해를 3번 줍니다.' }, 
  ...
  { name: '심해의 악몽', baseHp: 875, deck: [
    { name: '먹물 뿜기', type: 'attack_debuff', value: 32, debuff: 'frail', turns: 4, desc: '정신을 오염시키는 칠흑 같은 먹물을 직사로 내뿜어 35의 피해를 주고 허약 4를 부여합니다.' }, 
    { name: '촉수 난타', type: 'attack', value: 17, multi: 4, desc: '어둠 속에서 수많은 촉수가 튀어나와 채찍처럼 사정없이 후려칩니다. 18의 피해를 4번 줍니다.' }, 
    { name: '심해의 재생', type: 'heal', heal: 80, desc: '몸을 비틀며 심연의 기운을 흡수해 뜯겨나간 살점을 복구합니다. 체력을 80 회복합니다.' }
  ]},
  { name: '타락한 성녀', baseHp: 937, deck: [
    { name: '신성한 불꽃', type: 'attack', value: 54, desc: '검게 물든 성화로 죄인을 태우듯 십자가 형상의 불길을 일으켜 60의 피해를 줍니다.' }, 
    { name: '거짓된 축복', type: 'attack_debuff', value: 27, debuff: 'vulnerable', turns: 3, desc: '축복을 가장한 저주를 내려 30의 피해를 주고 피부를 썩어들어가게 해 취약 3을 부여합니다.' }, 
    { name: '기적의 방패', type: 'defend', value: 90, desc: '기도를 올려 어둠의 빛줄기가 막아내는 절대적인 장막을 형성해 100의 방어도를 얻습니다.' }
  ]},
  { name: '강철 거수', baseHp: 1000, deck: [
    { name: '지진 일으키기', type: 'attack_debuff', value: 41, debuff: 'weak', turns: 3, desc: '강철 기둥 같은 다리로 땅을 내리찍어 지진을 일으켜 45의 피해를 주고 약화 3을 부여합니다.' }, 
    { name: '초고열 용광로', type: 'buff', buff: 'strength', buffValue: 5, desc: '체내의 엔진이 굉음을 내며 시뻘겋게 과열되어 근력을 5 얻습니다.' }, 
    { name: '육중한 돌진', type: 'attack', value: 63, desc: '브레이크 없이 모든 것을 부수며 맹렬하게 전진하여 70의 피해를 줍니다.' }
  ]},
  { name: '핏빛 군단장', baseHp: 1062, deck: [
    { name: '참수격', type: 'attack', value: 72, desc: '피로 물든 대검을 단숨에 휘둘러 머리를 노리는 필살의 일격으로 80의 피해를 줍니다.' }, 
    { name: '출혈 강요', type: 'attack_debuff', value: 36, debuff: 'mark', turns: 5, desc: '살점을 도려내어 멈추지 않는 출혈을 일으켜 40의 피해를 주고 표식 5를 부여합니다.' }, 
    { name: '군단의 방진', type: 'defend', value: 108, desc: '유령 군단병들을 소환해 철통같은 방진을 짜 120의 방어도를 얻습니다.' }
  ]},
  { name: '역병의 사도', baseHp: 1125, deck: [
    { name: '부패의 숨결', type: 'attack_debuff', value: 27, debuff: 'poison', turns: 6, desc: '고름이 터지는 소리와 함께 썩은 숨을 뱉어내 30의 피해를 주고 중독 6을 부여합니다.' }, 
    { name: '질병 전파', type: 'debuff', debuff: 'frail', turns: 5, desc: '지팡이를 쾅 찍어 쥐떼와 병균을 온 사방에 퍼뜨려 허약 5를 부여합니다.' }, 
    { name: '죽음의 포옹', type: 'attack_heal', value: 45, heal: 50, desc: '뼈만 남은 팔로 껴안으며 생명력을 흡수해 50의 피해를 주고 체력을 50 회복합니다.' }
  ]},
  { name: '그림자 군주', baseHp: 1187, deck: [
    { name: '어둠의 장막', type: 'debuff', debuff: 'silence', turns: 1, desc: '빛이 존재하지 않는 완전한 어둠 속으로 끌고 들어가 침묵 1을 부여합니다.' }, 
    { name: '그림자 베기', type: 'attack', value: 23, multi: 4, desc: '사방의 그림자에서 시퍼런 칼날들이 솟구쳐나와 25의 피해를 4번 연속 줍니다.' }, 
    { name: '허구의 방패', type: 'defend', value: 135, desc: '실체가 없는 환영으로 공간을 일그러뜨려 150의 방어도를 얻습니다.' }
  ]},
  { name: '고대 용의 망령', baseHp: 1250, deck: [
    { name: '망령 브레스', type: 'attack_debuff', value: 63, debuff: 'vulnerable', turns: 4, desc: '푸른 혼백이 섞인 차가운 불꽃을 토해내 70의 피해를 주고 영혼을 얼려 취약 4를 부여합니다.' }, 
    { name: '원혼 폭발', type: 'attack', value: 90, desc: '주변의 원혼들을 닥치는 대로 빨아들였다가 한 번에 폭발시켜 100의 피해를 줍니다.' }, 
    { name: '영혼 착취', type: 'attack_heal', value: 36, heal: 80, desc: '거대한 영체의 발톱으로 정신을 짓누르고 생명력을 뜯어내어 40의 피해를 주고 체력을 80 회복합니다.' }
  ]},
  { name: '지옥의 재판관', baseHp: 1375, deck: [
    { name: '사형 선고', type: 'debuff', debuff: 'mark', turns: 10, desc: '불타는 망치를 두드리며 영혼에 지워지지 않는 죄인 낙인을 찍어 표식 10을 부여합니다.' }, 
    { name: '죄악 심판', type: 'attack', value: 27, multi: 5, desc: '단두대의 칼날이 쉴 새 없이 떨어져내리는 듯한 환상과 함께 30의 피해를 5번 줍니다.' }, 
    { name: '구속구 채우기', type: 'attack_debuff', value: 45, debuff: 'bind', turns: 1, desc: '시뻘겋게 달아오른 쇠사슬을 휘감아 살을 지지며 50의 피해를 주고 속박 1을 부여합니다.' }
  ]},
  { name: '공허의 파괴자', baseHp: 1500, deck: [
    { name: '차원 분쇄', type: 'attack', value: 108, desc: '손짓 한 번으로 공간 자체를 쪼개버려 방어 불가 수준의 120의 피해를 줍니다.' }, 
    { name: '존재 소멸', type: 'debuff', debuff: 'silence', turns: 2, desc: '기억과 마력 회로를 강제로 끊어버리는 파동을 뿜어 침묵 2를 부여합니다.' }, 
    { name: '공허 흡수', type: 'defend_buff', value: 180, buff: 'strength', buffValue: 5, desc: '주변의 모든 빛과 마력을 빨아들이는 블랙홀을 형성해 200의 방어도를 얻고 근력을 5 얻습니다.' }
  ]},
  { name: '종말의 전령', baseHp: 1875, deck: [
    { name: '종말의 도래', type: 'attack_debuff', value: 135, debuff: 'frail', turns: 5, desc: '하늘이 무너져내리는 환상과 함께 압도적인 재앙을 선사해 150의 피해를 주고 허약 5를 부여합니다.' }, 
    { name: '절망의 빛', type: 'attack', value: 36, multi: 5, desc: '검은 태양에서 쏟아지는 절망적인 광선을 쏘아 40의 피해를 5번 줍니다.' }, 
...
export const SPECIAL_BOSSES = {
  25: { name: '거미 여왕', baseHp: 625, rewardCards: ['spider_queens_web', 'spider_queen_poison'], passives: [], deck: [
    { name: '맹독 샤워', type: 'attack_debuff', value: 14, multi: 2, debuff: 'weak', turns: 2, desc: '천장에서 독액 비를 쏟아내려 피부를 태웁니다. 15의 피해를 2번 주고 약화 2를 부여합니다.' }, 
    { name: '여왕의 명령', type: 'defend_debuff', value: 45, debuff: 'vulnerable', turns: 2, desc: '기분 나쁜 울음소리로 새끼 거미들을 방패막이로 세웁니다. 50의 방어도를 얻고 취약 2를 부여합니다.' }
  ]},
  50: { name: '김삠삐', baseHp: 1875, rewardCards: ['twerking'], passives: [{ id: 'revive', name: '1회 부활', desc: '사망 시 체력을 50% 회복하고 1회 부활합니다.' }], deck: [
    { name: '트월킹', type: 'attack_debuff', value: 27, debuff: 'vulnerable', turns: 2, desc: '도저히 눈 뜨고 볼 수 없는 격렬한 엉덩이 흔들기로 충격파를 생성해 30의 피해를 주고 넋을 빼놓아 취약 2를 부여합니다.' }, 
    { name: '도발', type: 'defend_buff', value: 45, buff: 'strength', buffValue: 6, desc: '건방진 포즈로 약을 올리며 방어 태세를 갖춥니다. 50의 방어도를 얻고 분노 에너지로 근력을 6 얻습니다.' }, 
    { name: '회보오옥!', type: 'heal', heal: 200, desc: '이상한 소리를 지르며 빛줄기에 감싸여 상처를 꿰매 체력을 200 회복합니다.' }
  ]},
  75: { name: '수라의 왕', baseHp: 3125, rewardCards: ['asuras_wrath', 'power_of_asura', 'supreme_blade_storm'], passives: [{ id: 'scaling_strength', name: '끝없는 분노', desc: '매 턴 시작 시 근력이 3 증가합니다.' }], deck: [
    { name: '육도윤회', type: 'attack', value: 14, multi: 6, desc: '여섯 개의 팔이 눈에 보이지 않는 궤적으로 쏟아져 내려 15의 피해를 6번 연속으로 줍니다.' }, 
    { name: '금강불괴', type: 'defend', value: 90, desc: '전신의 근육을 바위처럼 경화시켜 어떤 공격도 튕겨낼 듯한 100의 방어도를 얻습니다.' }, 
    { name: '파괴의 눈', type: 'debuff', debuff: 'vulnerable', turns: 5, desc: '이마에 위치한 제3의 눈을 번쩍 떠서 영혼을 짓누릅니다. 취약 5를 부여합니다.' }
  ]},
  100: { name: '스스스슬라임', baseHp: 1000, rewardCards: ['slime_snot', 'slimes_greed'], passives: [{ id: 'revive', name: '1회 부활', desc: '사망 시 체력을 50% 회복하고 1회 부활합니다.' }], deck: [
    { name: '트리플 어택', type: 'attack', value: 18, multi: 3, desc: '세 갈래로 거대하게 분열하여 동시에 짓눌러 20의 피해를 3번 줍니다.' }, 
    { name: '산성비', type: 'attack_debuff', value: 36, debuff: 'weak', turns: 3, desc: '온몸의 독액을 하늘로 뿜어내어 산성비를 내리게 해 40의 피해를 주고 약화 3을 부여합니다.' }, 
    { name: '단단한 결속', type: 'defend_buff', value: 90, buff: 'strength', buffValue: 5, desc: '흩어진 점액들을 한 점으로 초압축하여 100의 방어도를 얻고 밀도를 높여 근력을 5 얻습니다.' }
  ]},
  ...
  H50: {  
    ...
    deck: [
      { name: '초월 낙하', type: 'attack', value: 27, desc: '구름 위까지 도약했다가 유성처럼 떨어져 30의 피해를 줍니다.' },
      { name: '마력 재생', type: 'heal', heal: 250, desc: '대지의 마맥을 빨아들여 투명하게 빛나며 체력을 250 회복합니다.' },
      { name: '강산성 점액', type: 'attack_debuff', value: 14, debuff: 'frail', turns: 2, desc: '닿기만 해도 뼈가 삭는 점액질을 뿜어 15의 피해를 주고 허약 2를 부여합니다.' },
      { name: '분열 타격', type: 'attack', value: 9, multi: 4, desc: '수십 개의 미니 슬라임으로 나뉘어 일제히 융단 폭격을 가해 10의 피해를 4번 줍니다.' },
      { name: '끈적한 늪', type: 'debuff', debuff: 'bind', turns: 1, desc: '전투 공간을 온통 끈적이는 슬라임 지대로 만들어 발을 묶어 속박 1을 부여합니다.' },
      { name: '탄성 강화', type: 'defend', value: 135, desc: '젤리 같은 몸통을 진동시켜 모든 충격을 무효화하는 150의 방어도를 얻습니다.' },
      { name: '슬라임 웨이브', type: 'attack_debuff', value: 18, debuff: 'weak', turns: 2, desc: '거대한 점액의 해일을 일으켜 20의 피해를 주고 휩쓸리게 해 약화 2를 부여합니다.' },
      { name: '맹독 뱉기', type: 'attack_debuff', value: 9, debuff: 'poison', turns: 5, desc: '응축된 맹독 구슬을 기관총처럼 뱉어내 10의 피해를 주고 중독 5를 부여합니다.' }
    ] 
  },
  H100: { 
    name: '기계화된 골렘', 
    ...
    deck: [
      { name: '섬멸 레이저', type: 'attack', value: 23, multi: 3, desc: '가슴이 열리며 세 가닥의 섬멸 레이저가 교차하며 25의 피해를 3번 줍니다.' },
      { name: '철벽 가동', type: 'defend', value: 270, desc: '전면 장갑을 육각형 쉴드로 덮으며 절대적인 300의 방어도를 전개합니다.' },
      { name: '동력 충전', type: 'buff', buff: 'strength', amount: 5, desc: '엔진이 굉음을 내며 시뻘겋게 달아오르고 리미터가 해제되어 근력을 5 얻습니다.' },
      { name: '지진 일으키기', type: 'attack_debuff', value: 36, debuff: 'vulnerable', turns: 3, desc: '거대한 강철 다리로 대지를 짓밟아 40의 피해를 주고 균형을 무너뜨려 취약 3을 부여합니다.' },
      { name: '오토 리페어', type: 'heal', heal: 400, desc: '나노 로봇을 가동해 찌그러진 장갑을 즉각 복구하며 체력을 400 회복합니다.' },
      { name: '로켓 펀치', type: 'attack', value: 63, desc: '팔뚝에서 부스터가 뿜어져 나오며 날아가는 펀치로 70의 묵직한 피해를 줍니다.' },
      { name: '방출', type: 'attack', value: 14, multi: 5, desc: '과열된 증기와 쇳조각들을 사방으로 뿜어내어 15의 피해를 5번 줍니다.' },
  ...
  H150: { 
    ...
    deck: [
      { name: 'Fatal Error', type: 'attack_debuff', value: 54, debuff: 'vulnerable', turns: 5, desc: '공간의 픽셀이 깨지며 끔찍한 노이즈와 함께 60의 피해를 주고 취약 5를 부여합니다.' },
      { name: 'Null Pointer', type: 'debuff', debuff: 'silence', turns: 1, desc: '존재의 좌표를 삭제하려 들어 의식을 일시적으로 끊어버립니다. 침묵 1을 부여합니다.' },
      { name: 'Memory Leak', type: 'attack_debuff', value: 18, debuff: 'poison', turns: 10, desc: '생명력을 서서히 갉아먹는 바이러스 코드를 주입해 20의 피해를 주고 중독 10을 부여합니다.' },
      { name: 'Overflow', type: 'attack', value: 72, desc: '처리 용량을 초과하는 에너지를 강제로 욱여넣어 내부에서 터지게 해 80의 피해를 줍니다.' },
      ...
      { name: 'Corrupted File', type: 'attack_debuff', value: 27, debuff: 'bind', turns: 1, desc: '오염된 데이터를 뒤집어씌워 관절을 굳게 만들어 30의 피해와 속박 1을 부여합니다.' },
      { name: 'Blue Screen', type: 'attack_debuff', value: 45, debuff: 'frail', turns: 3, desc: '망막에 파란 화면이 강제로 띄워지며 시스템을 다운시켜 50의 피해와 허약 3을 부여합니다.' }
    ] 
  },
  H200: { 
    name: '종말의 정적', 
    ...
    deck: [
      ...
      { name: '공허의 방패', type: 'defend', value: 450, desc: '공격 자체가 존재하지 않았던 것처럼 무효화시키는 절대적인 500의 방어도를 전개합니다.' },
      { name: '잊혀진 기억', type: 'debuff', debuff: 'mark', turns: 20, desc: '지워진 존재들의 원념이 들러붙어 영원히 벗어날 수 없는 표식 20을 부여합니다.' },
      { name: '사라지는 시간', type: 'attack', value: 23, multi: 4, desc: '시공간이 깎여나가며 몸의 일부가 먼지로 변해 25의 피해를 4번 연속 받습니다.' }
    ] 
  },
  H250_A: { 
    name: '릴리스 (서큐버스 언니)', 
    ...
    deck: [
      ...
      { name: '언니의 보호', type: 'defend', value: 360, desc: '박쥐 떼를 거대한 망토처럼 둘러 모든 공격을 대신 맞게 해 400의 방어도를 얻습니다.' },
      { name: '선혈 베기', type: 'attack', value: 81, desc: '피로 만들어진 거대한 낫을 허공에 긋듯 휘둘러 90의 묵직한 피해를 줍니다.' }
    ] 
  },
  H250_B: { 
    name: '모리건 (서큐버스 동생)', 
    ...
    deck: [
      { name: '유혹의 입맞춤', type: 'attack_debuff', value: 18, debuff: 'weak', turns: 3, desc: '달콤한 독이 묻은 몽환적인 입맞춤을 날려 20의 피해를 주고 약화 3을 부여합니다.' },
      { name: '악몽 주입', type: 'attack_debuff', value: 27, debuff: 'silence', turns: 1, desc: '정신을 갉아먹는 달콤한 악몽을 머릿속에 욱여넣어 30의 피해를 주고 침묵 1을 부여합니다.' },
      { name: '그림자 늪', type: 'debuff', debuff: 'bind', turns: 1, desc: '발밑의 그림자가 끈적한 촉수로 변해 몸을 휘감으며 속박 1을 부여합니다.' },
      { name: '환락의 저주', type: 'attack_debuff', value: 36, debuff: 'vulnerable', turns: 3, desc: '고통조차 쾌락으로 느끼게 만드는 핑크빛 안개를 뿜어 40의 피해를 주고 취약 3을 부여합니다.' },
      { name: '동생의 응원', type: 'heal', heal: 400, desc: '언니를 응원하며 자신과 언니 주변에 치유의 오라를 둘러 체력을 400 회복합니다.' }, 
      { name: '영혼 흡취', type: 'attack_heal', value: 45, heal: 200, desc: '가까이 다가와 영혼의 에너지를 깊게 들이마셔 50의 피해를 주고 체력을 200 회복합니다.' },
      { name: '어둠의 장막', type: 'defend', value: 270, desc: '그림자 속에 완전히 몸을 숨겨 일체의 타격을 받지 않는 300의 방어도를 얻습니다.' }
    ] 
  },
  H300: { 
    name: '태초의 아케인: 에이온', 
    ...
    deck: [
      { name: '빅뱅', type: 'attack', value: 23, multi: 8, desc: '우주가 탄생하는 순간의 압도적인 에너지를 압축하여 터뜨려 25의 피해를 8번 연속 줍니다.' },
      { name: '세계선 붕괴', type: 'attack_debuff', value: 72, debuff: 'vulnerable', turns: 5, desc: '주변의 시공간 차원을 찢어발기며 80의 피해를 주고 존재 자체를 취약하게 만들어 취약 5를 부여합니다.' },
      ...
      { name: '차원 단절', type: 'defend', value: 900, desc: '자신과 세상을 분리하는 차원의 벽을 쳐 어떠한 간섭도 허용하지 않는 999의 방어도를 얻습니다.' },
      { name: '은하 분쇄', type: 'attack', value: 180, desc: '거대한 은하계를 축소시켜 적의 머리 위로 그대로 내리꽂아 200의 파멸적인 피해를 줍니다.' },
      { name: '인과율 조작', type: 'debuff', debuff: 'bind', turns: 2, desc: '행동의 결과값을 강제로 삭제해 아무것도 하지 못하게 만들어 속박 2를 부여합니다.' },
      { name: '태초의 빛', type: 'attack', value: 45, multi: 3, desc: '시작과 끝을 알리는 성스러운 광선을 세 갈래로 쏘아내어 50의 피해를 3번 줍니다.' },
      { name: '절대 권력', type: 'buff', buff: 'strength', amount: 10, desc: '우주의 이치를 거스르는 압도적인 권능을 발현해 스스로의 한계를 부수고 근력을 10 얻습니다.' },
      { name: '종말 카운트다운', type: 'attack_debuff', value: 90, debuff: 'mark', turns: 10, desc: '머리 위에 파멸을 예고하는 거대한 모래시계를 띄워 99의 피해를 주고 지워지지 않는 표식 10을 부여합니다.' }
    ] 
  }
};