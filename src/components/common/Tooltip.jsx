...
export default function Tooltip({ desc }) {
  ...
  return (
    <div className="relative inline-block group ml-1 align-middle">
      ...
      {/* 화면 위쪽이 아닌 아래쪽으로 표시되게 변경, 짤림 방지용 z-index 상향 */}
      <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 hidden group-hover:block w-48 p-2 bg-slate-900 border border-slate-700 rounded-lg shadow-2xl z-[99999] pointer-events-none">
        {/* 화살표 방향을 위로 변경 */}
